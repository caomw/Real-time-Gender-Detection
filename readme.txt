---------------------------------------------------------------------------------------------------------------------------
Copyright(c) 2015 Lijia Lu, Weiyang Liu (Authors)
All Rights Reserved.
---------------------------------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------------------------------
About the demos
Run FaceDetection.m for a real-time Gender detection Demo. (PS: Photo button is for real-time gender detection, Picture button is for local image.)

--------------------
A USB camera (or laptop camera) is required for this demo! 
--------------------

---------------------------------------------------------------------------------------------------------------------------
When using the code in your research work, you should cite the following paper:

Lijia Lu, Weiyang Liu, Yandong Wen, and Yuexian Zou.  "Automatical Gender Detection for Unconstrained Video Sequences Based on Collaborative Representation." 12th IEEE International Conference on Signal Processing (ICSP), Hangzhou, China, 2014.

---------------------------------------------------------------------------------------------------------------------------

For any problem about the codes, please contact to {lulijia@sz.pku.edu.cn} & {wyliu@pku.edu.cn}.
